...
import { $ as define_default, A as round_default, B as rgb_default, C as linear$1, D as implicit, E as point, F as date_default, G as Color, H as nogamma, I as array_default, J as color, K as Rgb, L as numberArray_default, M as string_default, N as object_default, O as ordinal, P as number_default, Q as rgbConvert, R as rgbBasis, S as identity, T as band, U as basisClosed_default$1, V as hue, W as basis_default$1, X as hsl, Y as darker, Z as rgb, _ as radial, a as divergingSymlog, b as symlog, c as sequentialLog, d as sequentialSymlog, et as extend, f as utcTime, g as quantile$1, h as quantize, i as divergingSqrt, j as value_default, k as piecewise, l as sequentialPow, m as threshold, n as divergingLog, o as sequentialQuantile, p as time, q as brighter, r as divergingPow, s as sequential, t as diverging, u as sequentialSqrt, v as pow, w as tickFormat, x as log, y as sqrt, z as rgbBasisClosed } from "./src-owky9rVJ.js";
...
function axis(orient, scale) {
	...
	function axis(context) {
		var values = tickValues == null ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues, format = tickFormat == null ? scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity_default$4 : tickFormat, spacing = Math.max(tickSizeInner, 0) + tickPadding, range = scale.range(), range0 = +range[0] + offset, range1 = +range[range.length - 1] + offset, position = (scale.bandwidth ? center : number)(scale.copy(), offset), selection = context.selection ? context.selection() : context, path = selection.selectAll(".domain").data([null]), tick = selection.selectAll(".tick").data(values, scale).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
...
function data_default$1(value, key) {
	...
	if (typeof value !== "function") value = constant_default$9(value);
...
function drag_default() {
	...
	drag.filter = function(_) {
		return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default$8(!!_), drag) : filter;
	};
	drag.container = function(_) {
		return arguments.length ? (container = typeof _ === "function" ? _ : constant_default$8(_), drag) : container;
	};
	drag.subject = function(_) {
		return arguments.length ? (subject = typeof _ === "function" ? _ : constant_default$8(_), drag) : subject;
	};
	drag.touchable = function(_) {
		return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default$8(!!_), drag) : touchable;
	};
	drag.on = function() {
...
//#endregion
//#region node_modules/d3/node_modules/d3-time-format/src/isoFormat.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-time-format/src/isoParse.js
